...
- **lectures/**  
  ...
  4. LTI Systems
  5. LTI Difference Equations
  6. LCC Difference Equations
  7. Frequency Response
  8. DTFT (Discrete-Time Fourier Transform)
  9. Z Transform
...
- **Language:** LaTeX
- **Intended Audience:** Undergraduate students in Electrical & Computer Engineering
